...
class TestAIGenerator:
    ...
    @patch('ai_generator.anthropic.Anthropic') 
    def test_generate_response_with_conversation_history(self, mock_anthropic, ai_generator):
    ...
    @patch('ai_generator.anthropic.Anthropic')
    def test_generate_response_with_tools_no_use(self, mock_anthropic, ai_generator, mock_tool_manager):
    ...
    @patch('ai_generator.anthropic.Anthropic')
    def test_generate_response_with_single_tool_use(self, mock_anthropic, ai_generator, mock_tool_manager):
        ...
        try:
            ...
            final_response = MockResponse(
                content=[MockContent(type="text", text="Based on the search results, here's what I found...")],
                stop_reason="end_turn"
            )
            ...
            mock_tool_manager.execute_tool.return_value = "Search results: Machine learning is..."
    ...
    @patch('ai_generator.anthropic.Anthropic')
    def test_tool_execution_handling(self, mock_anthropic, ai_generator, mock_tool_manager):
        ...
        try:
            ...
            result = ai_generator._handle_tool_execution(tool_use_response, base_params, mock_tool_manager)
    ...
    @patch('ai_generator.anthropic.Anthropic')
    def test_sequential_tool_calls(self, mock_anthropic, ai_generator, mock_tool_manager):
        ...
        try:
            ...
            second_tool_response = MockResponse(
                content=[MockContent(
                    ...
                    id="tool_2",
                    name="search_course_content",
                    input={"query": "lesson 3 content", "course_name": "MCP Course"}
                )],
                stop_reason="tool_use"
            )
            ...
            final_response = MockResponse(
                content=[MockContent(type="text", text="Here's the comprehensive information about lesson 3...")],
                stop_reason="end_turn"
            )
            
            mock_client.messages.create.side_effect = [first_tool_response, second_tool_response, final_response]
    ...
    @patch('ai_generator.anthropic.Anthropic')
    def test_max_rounds_enforcement(self, mock_anthropic, ai_generator, mock_tool_manager):
        ...
        try:
            ...
            final_response = MockResponse(
                content=[MockContent(type="text", text="Final answer after max rounds")],
                stop_reason="end_turn"
            )
...
class TestAIGeneratorIntegration:
    ...
    @patch('ai_generator.anthropic.Anthropic')
    def test_sequential_integration_with_real_tools(self, mock_anthropic, real_tool_manager):
        ...
        try:
            ...
            final_response = MockResponse(
                content=[MockContent(type="text", text="Sequential integration successful")],
                stop_reason="end_turn"
            )
            ...
            assert mock_store.search.call_count == 1  # Only content search, outline uses different method
