...
class TestCourseSearchTool:
    ...
    def test_execute_basic_search(self, search_tool, mock_vector_store, sample_search_results):
    ...
    def test_execute_with_both_filters(self, search_tool, mock_vector_store, sample_search_results):
        ...
        try:
            ...
            result = search_tool.execute("topics", course_name="Test Course", lesson_number=1)
    ...
    def test_execute_empty_results(self, search_tool, mock_vector_store):
        ...
        try:
            ...
            result = search_tool.execute("topic", course_name="Test Course", lesson_number=1)
    ...
    def test_source_tracking(self, search_tool, mock_vector_store, sample_search_results):
